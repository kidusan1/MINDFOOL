  ...
  {text}
        ...
        <div className="w-full flex flex-col items-center shrink-0 z-10">
          <div 
            ...
            className="w-full max-w-lg bg-cloud rounded-[2.5rem] p-6 md:p-8 flex flex-col items-center justify-center border border-white/40 shadow-sm transition-all duration-100 cursor-pointer active:brightness-95 touch-manipulation"
          >
